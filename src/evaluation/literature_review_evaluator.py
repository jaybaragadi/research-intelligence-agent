...
class LiteratureReviewEvaluator:
    ...
    def evaluate_case(
        ...
        review_papers = self._unique_in_order(
            review.paper_ids
        )
        ...
        missing_review_papers = [
            ...
            if paper_id not in review_papers
        ]
        ...
        expected_section_types = [
            section_type.value
            for section_type
            in LiteratureReviewSectionType
        ]
        ...
        missing_section_types = [
            section_type
            for section_type
            in expected_section_types
            if section_type
            not in section_counts
        ]

        duplicate_section_types = [
            section_type
            for section_type, count
        ...
        section_structure_complete = (
            ...
            and len(review.sections)
            == len(expected_section_types)
        )
        ...
        corpus_scope_note_present = bool(
            ...
            and review.corpus_scope_note.strip()
        )
