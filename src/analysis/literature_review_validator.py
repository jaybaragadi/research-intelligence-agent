...
class LiteratureReviewGroundingValidator:
    ...
    def validate(
        ...
        for finding in synthesis.findings:
            ...
            if (
                not finding.is_cross_paper
                and actual_support_count > 1
            ):
                issues.append(
                    LiteratureReviewValidationIssue(
                        code=(
