...
RESULT_PATH = Path("evaluation/results/retrieval_cross_encoder_results.json")
...
def main() -> None:
    ...
    print()
    print("Cross-Encoder Retrieval Evaluation")
    print("==================================")
    ...
    print("Saved cross-encoder evaluation results to:")
    print(RESULT_PATH)
