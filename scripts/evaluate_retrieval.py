...
def main() -> None:
    ...
    cases = load_retrieval_benchmark(
        BENCHMARK_PATH
    )
    ...
    print(
        f"Mean Recall@3: "
        f"{metrics.mean_recall_at_3:.2%}"
    )

    print(
        f"Mean Recall@5: "
        f"{metrics.mean_recall_at_5:.2%}"
    )

    print(
        f"Mean Recall@10: "
        f"{metrics.mean_recall_at_10:.2%}"
    )
    ...
    for result in results:
        ...
        print(
            f"  Hit@5: {result.hit_at_5:.2%}"
        )

        print(
            "  Matched:",
            ", ".join(
                result.matched_papers
            )
            or "None",
        )
