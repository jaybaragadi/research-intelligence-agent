    ...
    def search(
        ...
        results = [
            RetrievedChunk(
                ...
                text=(
                    "Paper A uses mutation "
                    "testing to improve tests."
                ),
            ),
            ...
            RetrievedChunk(
                ...
                text=(
                    "Paper B uses coverage "
                    "feedback to improve tests."
                ),
            ),
