...
def test_unknown_evidence_fails():
    ...
    assert result.issues[0].issue_type == "unknown_evidence"
...
def test_duplicate_claim_id_fails():
    ...
    assert any(issue.issue_type == "duplicate_claim_id" for issue in result.issues)
