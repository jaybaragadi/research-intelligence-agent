...
def create_chunks() -> list[PaperChunk]:

    first_text = "Mutation testing improves " "test quality."

    second_text = "Coverage-guided generation " "improves branch coverage."
